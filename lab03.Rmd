...
though you may now use multivariate models. Also, please only
...
Make sure to include at a minimum several plots and showing how well
your final models performs on the validation set.
...
And to load the mpg dataset:

```{r}
mpg <- read_csv("https://statsmaths.github.io/ml_data/mpg.csv")
```

The dataset gives characterists of various automobiles.
Your goal is to use characterists of the cars to estimate
their city fuel efficency.
